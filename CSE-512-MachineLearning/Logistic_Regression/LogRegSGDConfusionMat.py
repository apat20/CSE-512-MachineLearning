...
cm_1 = confusion_matrix(train_true_labels, train_predicted_labels)
print(cm_1)
...
plt.show()
#plt.imsave('Confusion_matrix_train.jpg')

cm_2 = confusion_matrix(val_true_labels, val_predicted_labels)
print(cm_2)
# Show confusion matrix in a separate window
plt.matshow(cm_1)
plt.title('Confusion matrix')
...
plt.xlabel('Predicted label')
plt.show()
#plt.imsave('Confusion_matrix_val.jpg')